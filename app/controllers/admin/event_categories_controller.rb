class Admin::EventCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_category.save
        format.html { redirect_to admin_event_category(@event_category), notice: 'Event category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_category.update(event_category_params)
        format.html { redirect_to admin_event_category_path(@event_category), notice: 'Event category was successfully updated.' }
  ...
  private
    ...
    def event_category_params
      params.require(:event_category).permit(:name, :slug)
    end
end
