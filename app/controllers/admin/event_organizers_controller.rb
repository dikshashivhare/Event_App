class Admin::EventOrganizersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_organizer.save
        format.html { redirect_to admin_event_organizer_path(@event_organizer), notice: 'Event organizer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_organizer.update(event_organizer_params)
        format.html { redirect_to admin_event_organizer_path(@event_organizer), notice: 'Event organizer was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_event_organizers_url, notice: 'Event organizer was successfully destroyed.' }
  ...
  private
    ...
    def event_organizer_params
      params.require(:event_organizer).permit(:name, :email, :address, :city, :state, :country, :latitude, :longitude, :logo_image, :contact, :slug)
    end
end
