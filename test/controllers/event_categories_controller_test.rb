...
class EventCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_category" do
    assert_difference('EventCategory.count') do
      post event_categories_url, params: { event_category: { name: @event_category.name, slug: @event_category.slug } }
    end
  ...
  test "should update event_category" do
    patch event_category_url(@event_category), params: { event_category: { name: @event_category.name, slug: @event_category.slug } }
